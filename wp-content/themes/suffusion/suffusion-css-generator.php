...
#slider .left, #slider .right { height: $featured_height; width: $featured_excerpt_width !important; }
...
h2.suf-tile-title { text-align: $suf_tile_title_alignment; }";
	...
	function get_custom_tbrh_css() {
		global $suf_wa_tbrh_style, $suf_wa_tbrh_panel_color, $suf_wa_tbrh_panel_border_color, $suf_wa_tbrh_panel_font_color;
		$ret = "";

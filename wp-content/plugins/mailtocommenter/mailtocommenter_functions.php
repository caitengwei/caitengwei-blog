...
function mailtocommenter_button(){
	...
	echo "<a href=\"#commentform\" title=\"{$title}\" onclick=\"document.getElementById('comment').focus();document.getElementById('comment').value += '{$value}'\" style=\"text-decoration:none\">{$display}</a>";
}
